...
const HomePage = () => {
    return (
        <div className="max-w-7xl mx-auto p-6 text-justify">
            <h1 className="text-4xl font-bold mb-4 text-pijet-blue">Welcome to PIJET (ISSN No. xxxx-xxxx)</h1>

            <div className="flex py-4">
                <div className="w-1/2 pr-4 py-5">
                    {/* Your static image goes here */}
                ...
                <div className="w-1/2 px-3 py-8">
                    ...
                    <div className="text-lg text-l">
                        ...
                        <p>
                            <strong>Submit Paper To:</strong> pijet@pict.edu
                        </p>
                        <p>
