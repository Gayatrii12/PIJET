            ...
            <form className="w-full max-w-lg mx-auto my-8">
                <div className="flex flex-wrap -mx-3 mb-6" >
                    <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0" >
                        ...
                        <input
                            className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${(state.fname === "" || state.fname === undefined) ? "border-red-500" : "border-green-500"
                    ...
                    <div className="w-full md:w-1/3 px-3" >
                        ...
                        <input
                            className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${(state.lname === "" || state.lname === undefined) ? "border-red-500" : "border-green-500"
                                } rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white`}
                            id="grid-last-name"
                            type="text"
                            name="lname"
                    ...
                    <div className="w-full md:w-1/3 px-3" >
                        ...
                        <input
                            className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${(state.organization === "" || state.organization === undefined) ? "border-red-500" : "border-green-500"
                                } rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white`}
                            id="grid-last-name"
                            type="text"
                            name="organization"
                    ...
                    <div className="w-full md:w-1/2 px-3" >
                        ...
                        <input
                            className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${(state.country === "" || state.country === undefined) ? "border-red-500" : "border-green-500"
                                } rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white`}
                            id="grid-last-name"
                            type="text"
                            name="country"
                    ...
                    <div className="w-full md:w-1/2 px-3" >
                        ...
                        <input
                            className={`appearance-none block w-full bg-gray-200 text-gray-700 border ${(state.email === "" || state.email === undefined || !/^\S+@\S+\.\S+$/.test(state.email)) ? "border-red-500" : "border-green-500"
                                } rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white`}
                            id="grid-password"
                            type="email"
                            name="email"
